...
const slides = [
  {
    ...
    testimony:
      "The delivery lead steered the project from what was a very waterfall beginning to delivering new functionality to the business every sprint. He took his time changing the mind set of everyone involved in the project left behind a team who continue building on the success he embedded.",
    ...
    <section className="testimonial-slider">
      <div className="testimonial-slider__container">
        <div className="testimonial-slider__inner">
          <ul className="testimonial-slider__slides">
            {slides.map((slide, i) => {
              const Image = () => {
                return (
                  <img
                    src={require(`../assets/images/${slide.photo}`)}
                    alt={slide.name}
                  />
                )
              }
              ...
              return (
                <li
                  ...
                  className={`testimonial-slider__slide ${
                    i === current ? "testimonial-slider__slide--active" : ""
                  }`}
                ...
                >
                  ...
                  <div className="testimonial-slider__content">
                    <p className="testimonial-slider__testimony">
                      &ldquo;{slide.testimony}&rdquo;
                    </p>
                    <h5 className="testimonial-slider__name">{slide.name}</h5>
                    <span className="testimonial-slider__position">
                      {slide.position}
                    </span>
                  </div>
                </li>
          ...
          <button
            className="testimonial-slider__button testimonial-slider__button--prev"
            onClick={handlePrev}
          >
            <i className="icon" />
          </button>
          ...
          <button
            className="testimonial-slider__button testimonial-slider__button--next"
            onClick={handleNext}
          >
            <i className="icon" />
          </button>
